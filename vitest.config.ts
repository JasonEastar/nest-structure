 ...
 * - unit        : `test/unit/**\/*.spec.ts` logic thuần, không hạ tầng, chạy trong < 5 s.
 * - integration : `test/integration/**\/*.spec.ts` — boot AppModule thật trên PostGIS + Redis do testcontainers dựng
