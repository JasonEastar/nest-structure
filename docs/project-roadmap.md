...
| 5. Redis | `common/redis.ts` (2 connection + CacheService), `common/throttler.guard.ts`, `common/queue.ts` + `pin.jobs.ts` | Rate limit đếm chung qua 2 instance; queue ping job chạy 1 lần | MVP | ☐ |
